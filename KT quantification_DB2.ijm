...
// Select file type to analyze. Only files ending in this
// use "" to read all files (this will include non-image files, so make sure there are none in your data folder
filetype = ".dv";
